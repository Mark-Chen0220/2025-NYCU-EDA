...
void costFunction(bool layerSwap, Gcell &cell){
    ...
    else if (cell.reachedUsingMetal == 1) cost += myGamma * cell.M1cost;
...
int main() {
    parseGMP("testcase2.gmp");
    parseGCL("testcase2.gcl");
    parseCST("testcase2.cst");
    ...
    printSolutionFile(bestSolution, "testcase2.lg");
    return 0;
}